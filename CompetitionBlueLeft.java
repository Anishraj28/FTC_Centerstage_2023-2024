...
public class CompetitionBlueLeft implements VisionProcessor {
    ...
    private final Scalar BLUE = new Scalar(0, 0, 255); // for debugging
    ...
    public Object processFrame(Mat inputMat, long ms) {
        Imgproc.cvtColor(inputMat, blue, Imgproc.COLOR_RGB2HSV); // convert RGB to HSV. We read the Saturation value.
        resizeRegions();
